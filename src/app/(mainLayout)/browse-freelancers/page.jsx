        ...
        {freelancers.map((user) => {
          ...
          return (
            <Link
              ...
              className="group bg-white rounded-3xl border border-slate-200 p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 relative overflow-hidden block"
            >
